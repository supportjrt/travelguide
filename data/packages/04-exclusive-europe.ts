...
export const exclusiveEurope: Package = {
  id: "exclusive-europe",
  ...
  itinerary: [
    {
      ...
      image: "/images/ExclusiveEurope/hero-image.jpg"
    },
    {
      day: 2,
  ...
  meals: {
    inclusions: [
      ...
      "09 Indian Jain/Vegetarian/Non-Vegetarian Lunches.",
      "10 Indian Jain/Vegetarian/Non-Vegetarian Dinners.",
      "Daily Mineral Water Bottle (500ml) per person"
    ],
    note: "(Packed lunch will be served on the day coming to Geneva & visiting Disneyland Paris)",
  ...
  detailedHighlights: [
    ...
    "Visit 5 countries in 11 days: France, Switzerland, Austria, Italy & Vatican City",
    "All Important attractions and sightseeing included: Guided tour of Versailles Palace, Eiffel Tower 3rd level, Full day at Disneyland® Paris, River Seine Cruise, Excursion to Jungfrau included, Entrance to Mt. Titlis, Swarovski Crystal Museum, Visit to St. Mark’s Square with Gondola Ride, Photo stop at Leaning Tower of Pisa and Visit Vatican City with St. Peter’s Basilica.",
    "Guided tour in Paris, Florence",
