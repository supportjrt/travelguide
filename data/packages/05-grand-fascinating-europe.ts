...
export const grandFascinatingEurope: Package = {
  ...
  itinerary: [
    {
      ...
      image: "/images/GrandFascinatingEurope/hero-image.jpg"
    },
    {
      day: 2,
  ...
  accommodation: [
    ...
    { title: "Geneva (01 Night)", hotel: "Everness / Movenpick Hotel or similar" },
    { title: "Central Switzerland (03 Nights)", hotel: "La Maison Suisse Döttingen / Radisson or similar" }
  ],
  route: [
    { city: "London", days: 2 },
    { city: "Paris", days: 3 },
  ...
  meals: {
    inclusions: [
      ...
      "08 Indian Jain/Vegetarian/Non-Vegetarian Lunches.",
  ...
  detailedHighlights: [
    ...
    "Visit 3 countries in 10 days: United Kingdom, France & Switzerland",
    "All Important attractions and sightseeing included. Madame Tussauds, London Eye, Lord’s Cricket Ground, Eurostar train from London to Paris, Guided tour of Versailles, Eiffel Tower 3rd level, Full day at Disneyland® Paris, River Seine Cruise, See the Jet d’Eau, Excursion to Jungfrau included, Visit Mt. Titlis, Cruise on Lake Lucerne, Lindt Home of Chocolate, Rhine Falls with boat ride.",
