...
export const fascinatingEurope: Package = {
  ...
  itinerary: [
    {
      ...
      activity: "Arrival",
      description: "Welcome! Today board our flight to one of the most beautiful and elegant city of Paris- known for its haute couture, renowned museums, breath-taking beautiful monuments and sensational cabarets. On arrival collect your baggage and proceed outside where you will be met by your professional tour manager, who will later escort you to your hotel. Check in and relax in the comforts of your hotel.\n\n**Overnight stay at the hotel in Paris. (Dinner)**",
      image: "/images/FascinatingEurope/hero-image.jpg"
    },
    {
      day: 2,
  ...
  meals: {
    ...
    note: "Packed lunch will be served on the day you visit Disneyland Paris and when the group drive to Geneva",
  ...
  detailedHighlights: [
    ...
    "Visit 2 countries in 8 days: France & Switzerland",
    "All Important attractions and sightseeing included. Guided tour of Versailles, Eiffel Tower 3rd level, Full day at Disneyland® Paris, River Seine Cruise, See the Jet d’Eau, Excursion to Jungfrau included, Visit Mt. Titlis, Cruise on Lake Lucerne, Lindt Home of Chocolate, Rhine Falls with boat ride.",
